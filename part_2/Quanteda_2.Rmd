...
```{r kwic5, exercise=TRUE, exercise.lines=12, fig.height=5}
data_tokens_inaugural <- tokens(data_corpus_inaugural)
...
```{r kwic5-solution, exercise.reveal_solution = TRUE, fig.height=5}
data_tokens_inaugural <- tokens(data_corpus_inaugural)
...
```{r kwic6_5, exercise=TRUE, fig.height=5}
library("quanteda.textplots")
...
```{r lexdev2, exercise=TRUE, exercise.setup = "prep-ire", fig.height=5}
...
```{r read2, exercise=TRUE, fig.height=5}
...
```{r read3, exercise=TRUE, exercise.setup = "prep-read", fig.height=6, fig.width=8.85,  exercise.lines=22}
...
```{r textstatwrap, exercise=TRUE, exercise.lines=32, fig.height=6}
...
```{r dist2, exercise=TRUE, exercise.setup = "prep-dist2", fig.height=6, fig.width=8}
...
```{r dist3, exercise=TRUE, exercise.lines=24, fig.height=6, fig.width=8}
